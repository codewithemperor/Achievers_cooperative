...
const mockTransactions = [
  ...
  { id: "6", type: "LOAN_DISBURSEMENT", amount: 100000, status: "APPROVED", date: "Mar 28, 2026", ref: "TXN-006" },
  { id: "7", type: "FUNDING", amount: 200000, status: "APPROVED", date: "Mar 15, 2026", ref: "TXN-007" },
  { id: "8", type: "SAVINGS", amount: -30000, status: "APPROVED", date: "Mar 1, 2026", ref: "TXN-008" },
];
...
export default function TransactionsPage() {
  return (
    <div className="mx-auto max-w-2xl px-4 py-6 sm:px-6">
      ...
      <p className="mt-1 text-sm text-slate-500">Complete history of all your transactions</p>
        ...
        {mockTransactions.map((tx) => (
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-[var(--brand-ink)]">{typeLabel[tx.type] || tx.type}</p>
