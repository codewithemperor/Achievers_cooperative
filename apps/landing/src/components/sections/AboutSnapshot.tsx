...
export default function AboutSnapshot() {
  return (
    <section className="bg-primary-900 text-background-50 py-20">
        ...
        <AnimatedSection>
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full border border-background-50/30 text-sm font-medium hover:bg-background-50 hover:text-primary-900 transition-all duration-200 whitespace-nowrap self-start md:self-auto"
            >
