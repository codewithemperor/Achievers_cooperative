    ...
    <section className="bg-background-100 py-24 overflow-hidden">
      <div className="section-padding mx-auto max-w-[1400px]">
        ...
        <AnimatedSection className="mb-16">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-semibold text-text-900 max-w-lg leading-[1.15]">
            {benefitsSection.headline}
          </h2>
          <p className="text-text-400 max-w-sm mt-4 leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="flex flex-col gap-5">
            ...
            <AnimatedSection delay={100}>
              <div className="relative h-64 rounded-4xl overflow-hidden bg-primary-700/20">
                <Image
