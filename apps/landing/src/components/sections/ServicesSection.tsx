...
export default function ServicesSection() {
  return (
    <section id="services" className="bg-coop-cream py-24">
      <div className="section-padding mx-auto max-w-[1400px]">
        <AnimatedSection className="mb-14">
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            ...
            <p className="max-w-sm leading-relaxed text-coop-muted">
          ...
          {services.map((service, i) => (
            <AnimatedSection key={service.slug} delay={i * 100}>
              <Link
                ...
                className="group block overflow-hidden rounded-4xl bg-coop-sand card-lift"
              >
                ...
                <div className="p-6">
                  <h3 className="mb-2 font-display text-xl font-semibold text-coop-dark">
                    {service.title}
                  </h3>
