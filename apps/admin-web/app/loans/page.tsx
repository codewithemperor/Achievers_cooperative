...
import { Card, Button, Chip, Textarea } from "@heroui/react";
    ...
    <div>
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-slate-500">
          Review loan applications and manage disbursements
        </p>
      </div>
        ...
        {[
          ...
          <Card key={stat.label} className="border border-slate-200 bg-white">
            <Card.Content className="p-4">
              ...
              <p className="mt-1 text-xl font-bold text-[var(--brand-ink)]">
                {stat.value}
              </p>
            </Card.Content>
          </Card>
                    ...
                    <td className="px-5 py-3 text-right">
                      {loan.status === "PENDING" && (
                        <div className="flex justify-end gap-2">
                          ...
                          <button
                            onClick={() =>
                              setRejectId(rejectId === loan.id ? null : loan.id)
                            }
              ...
              >
                ...
                <div className="mt-2 grid grid-cols-2 gap-2 text-xs">
                  ...
                  <div>
                    ...
                    <span>{loan.tenorMonths} months</span>
                  </div>
                ...
                {loan.status === "PENDING" && (
                  <div className="mt-3 flex gap-2">
                    <button className="flex-1 rounded-lg bg-green-50 py-2 text-xs font-medium text-green-600">
                      Approve
                    </button>
                    <button className="flex-1 rounded-lg bg-red-50 py-2 text-xs font-medium text-red-500">
                      Reject
                    </button>
                  </div>
                )}
