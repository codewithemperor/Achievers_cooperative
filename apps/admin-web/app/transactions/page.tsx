              ...
              >
                ...
                {tx.status === "PENDING" && (
                  <div className="mt-3 flex gap-2">
                    <button
                      onClick={() => setSelectedTx(tx.id)}
                      className="flex-1 rounded-lg bg-green-50 py-2 text-xs font-medium text-green-600"
                    >
                      Approve
                    </button>
                    <button
                      onClick={() => setRejectTx(tx.id)}
                      className="flex-1 rounded-lg bg-red-50 py-2 text-xs font-medium text-red-500"
                    >
                      Reject
                    </button>
                  </div>
