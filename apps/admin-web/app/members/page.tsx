                  ...
                  >
                    ...
                    <td className="px-5 py-3">
                      <Chip
                        size="sm"
                        color={
                          statusColor[member.status as keyof typeof statusColor]
                        }
                        variant="flat"
                      >
                        {member.status}
            ...
            {filtered.map((member) => (
              ...
              >
                ...
                <div className="mt-3 flex gap-2">
                  <button className="flex-1 rounded-lg border border-slate-200 py-2 text-xs font-medium text-slate-500">
                    View
                  </button>
                  {member.status === "PENDING" && (
